...
//		Shop updatedShop = shopRepository.findOne(shop.getIdShop());
//
//		if (updatedShop == null)
//			throw new ShopNotFound();
//
//		updatedShop.setTitle(shop.getTitle());
//		updatedShop.setUserName(shop.getUserName());
//		updatedShop.setRemindDate(shop.getRemindDate());
//		return updatedShop;
//	}
